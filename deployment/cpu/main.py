#!/usr/bin/env python3
"""
CPU deployment main entry point for hierarchical RAG system using llama.cpp
"""
import os
import logging
...
app = FastAPI(
    title="BEPS RAG System - CPU Deployment",
    description="Hierarchical RAG system with llama.cpp backend",
    version="1.0.0"
)
...
async def startup_event():
    ...
    logger.info("Starting BEPS RAG System - CPU Deployment")
    ...
    config.llm.model_name = os.getenv("MODEL_NAME", "llama-2-7b-chat.Q4_K_M.gguf")
...
async def health_check():
    ...
    return {"status": "healthy", "deployment": "cpu"}
